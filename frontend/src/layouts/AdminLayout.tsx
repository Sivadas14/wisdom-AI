...
import { LayoutDashboard, Users, CreditCard, History, LogOut, Bell, Images, BookOpen, Tags, Languages, ShieldCheck } from 'lucide-react';
...
const AdminLayout: React.FC = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/trials', label: 'Trial Access', icon: <ShieldCheck className="w-5 h-5" /> },
    ];
